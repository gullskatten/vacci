          ...
          <Modal>
            ...
            <Padding left="m" right="m">
              <Text variant="body" color="onSurface" element="p" gutterTop="m">
                ...
                an immune response in the vaccinated individual. As a result,
                the immune system will be able to “remember” the intruder
                causing the disease and attack it if you encounter the intruder
                in the future.
              </Text>
              <Text variant="body" color="onSurface" element="p" gutterTop="m">
                There exist many different vaccine types. Some of the types used
                against COVID-19, along with examples of each type, are
                presented in the table below. WHO provides a more detailed
                overview of the “landscape of novel coronavirus candidate
                vaccine development worldwide”. You can find it{" "}
